...
// NOTE: Site Activity Feed now uses actual_start/actual_end from InsightRow (activity-repo)
// instead of audit_log entries. See OperationsView.tsx for the client-side computation.
