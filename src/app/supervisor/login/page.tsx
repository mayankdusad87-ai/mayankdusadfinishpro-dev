    ...
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="relative md:w-[48%] lg:w-[45%] bg-[#162032] overflow-hidden flex flex-col items-center justify-center px-8 py-12 md:py-0 md:min-h-screen">
        ...
        <div className="absolute inset-0 opacity-[0.04]">
          ...
          <div className="absolute bottom-[15%] left-[5%] w-80 h-80 border border-white/30 rounded-full" />
          <div className="absolute top-[10%] left-[40%] w-48 h-48 border border-white/20 rounded-full" />
        </div>
