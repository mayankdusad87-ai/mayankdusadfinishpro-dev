...
import { vendorPerformance } from '@/lib/mock-data';
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-3">
            {vendorPerformance.map((vp) => (
              <div key={vp.vendor} className="flex items-center gap-4">
                <div className="w-40 text-sm text-gray-700 text-right shrink-0 truncate">
                  {vp.vendor}
                </div>
